...
import { createPersistedMcpAuthProvider } from "../engine/mcp-auth-provider";
...
const cleanupProviderGrantRefreshToken = (rows: EngineStoreShape, input: {
  previous: SecretRef;
  next: SecretRef;
}) =>
...
export const removeAuthLeaseAndSecrets = (rows: EngineStoreShape, input: {
