...
import { PolicyIdSchema, type LocalWorkspacePolicy, type PolicyId, type WorkspaceId } from "../../model";
import {
...
import { policy } from "../engine/db";
import { requireRuntimeLocalWorkspace } from "../engine/runtime-context";
...
const isHandledPolicyError = (
  ...
  | EngineNotFoundError
  | EngineStorageError =>
  cause instanceof EngineBadRequestError
  || cause instanceof EngineNotFoundError
  || cause instanceof EngineStorageError;
