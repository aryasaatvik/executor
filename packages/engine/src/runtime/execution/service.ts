...
): Effect.Effect<Execution, EngineNotFoundError | EngineStorageError> =>
  Effect.gen(function* () {
...
): Effect.Effect<ExecutionEnvelope, EngineNotFoundError | EngineStorageError> =>
  Effect.gen(function* () {
    const errors = asOperationErrors(input.operation);
...
): Effect.Effect<ExecutionEnvelope, EngineNotFoundError | EngineStorageError, never> =>
  Effect.gen(function* () {
