import { RUNS_TABLE_COLSPAN } from "./shell";

// A full-width "Live" divider row between past and newly-arrived runs. Rendered
// as a <tr><td colSpan> so it is valid inside the runs <tbody>.
export function LiveDivider() {
  return (
    <tr>
      <td colSpan={RUNS_TABLE_COLSPAN} className="p-0">
