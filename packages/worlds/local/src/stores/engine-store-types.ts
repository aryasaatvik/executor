...
export type EngineStoreShape = {
  authArtifacts: {
    ...
    }) => Effect.Effect<Option.Option<AuthArtifact>, Error, never>;
  ...
  authLeases: {
    ...
    ) => Effect.Effect<Option.Option<AuthLease>, Error, never>;
  ...
  sourceOauthClients: {
    getByWorkspaceSourceAndProvider: (input: {
      ...
      Option.Option<WorkspaceSourceOauthClient>,
      Error,
      never
    >;
    upsert: (
  ...
  workspaceOauthClients: {
    ...
    ) => Effect.Effect<Option.Option<WorkspaceOauthClient>, Error, never>;
  ...
  providerAuthGrants: {
    ...
    ) => Effect.Effect<Option.Option<ProviderAuthGrant>, Error, never>;
  ...
  sourceAuthSessions: {
    ...
    ) => Effect.Effect<Option.Option<SourceAuthSession>, Error, never>;
    getByState: (
    ...
    getPendingByWorkspaceSourceAndActor: (input: {
      ...
      Option.Option<SourceAuthSession>,
      Error,
      never
    >;
  ...
  secretMaterials: {
    ...
    ) => Effect.Effect<Option.Option<SecretMaterial>, Error, never>;
  ...
  executions: {
    ...
    ) => Effect.Effect<Option.Option<Execution>, Error, never>;
    getByWorkspaceAndId: (
  ...
  executionInteractions: {
    getById: (
      ...
      Option.Option<ExecutionInteraction>,
      Error,
      never
    >;
    listByExecutionId: (
  ...
  executionSteps: {
    ...
    ) => Effect.Effect<Option.Option<ExecutionStep>, Error, never>;
    listByExecutionId: (
      executionId: ExecutionStep["executionId"],
