...
import type { LocalConfigSecretProvider, LocalExecutorConfig } from "@executor/control-plane/model";
import { EngineStore, type EngineStoreShape } from "./engine-store-types";
import * as Context from "effect/Context";
import * as Effect from "effect/Effect";
import * as Layer from "effect/Layer";
import * as Option from "effect/Option";

import { resolveConfigRelativePath } from "../config/config";
import { fromConfigSecretProviderId } from "../config/config-secrets";
import { getRuntimeLocalWorkspaceOption } from "../config/runtime-context";
...
const createSecretMaterialStoreShape = (input: {
  ...
  localConfig?: LocalExecutorConfig | null;
  workspaceRoot?: string | null;
} = {}): Effect.Effect<SecretMaterialStoreShape, Error, EngineStore> =>
  Effect.gen(function* () {
