...
// D1 is the SQLite store (same FumaDB assembly as self-host), Dynamic Workers
// are the code substrate (per-execution isolates via the LOADER binding), no
// billing, single-tenant. The host-specific surface is just three injected
// Layers: identity, db, plugins/config.
//
